...
/***/ function(module, exports, __webpack_require__) {
	...
	var questions = [{
	  ...
	  options: ["После введения акциза газировка обязательно подорожает.", "Думаю, что цена на полке в магазине не изменится.", "Скорее всего, отечественную продукцию вытеснит аналогичная из стран ближнего зарубежья, например, Казахстана и Беларуси, где никаких акцизов нет"]
	}, {

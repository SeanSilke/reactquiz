...
/***/ function(module, exports, __webpack_require__) {
	...
	var questions = [{
	  ...
	  options: ["Часто (1-2 раза в неделю).", "Редко (не более 2 раз в месяц).", "Не пью совсем."]
	}, {
	  title: "Как вы оцениваете последствия введения акциза на сладкие газированные напитки?",
	  options: ["После введения акциза газировки обязательно подорожают.", "Думаю, что цена на полке в магазине не изменится.", "Скорее всего, отечественную продукцию вытеснит аналогичная из стран ближнего зарубежья, например, Казахстана и Беларуси, где никаких акцизов нет"]
	}, {
	  title: "Поддерживаете ли вы введение акцизов на сладкие газированные напитки?",
	  options: ["Да, мне кажется, это разумная мера.", "Нет, людям придется покупать газировку по более высокой цене.", "Я считаю, что покупатель должен обладать свободой выбора товаров."]
	}, {
	  title: "Станут ли россияне меньше пить газированные напитки, если на них введут акцизы?",
	  options: ["Скорее всего, да.", "Нет. Тот, кто пил, продолжит это делать, даже если баночка газировки подорожает на 5-10 рублей.", "Потребители будут искать другие аналоги газированным напиткам"]
	}, {
